...
// var word = prompt('enter Password')
// var result;
// document.write('Enter password: ' + word + '<br>');

// for (i = 0; i < word.length; i++) {
//     if (word.length >= 6) {
//         if (word[i].charCodeAt() >= 48 && word[i].charCodeAt() <= 57 || word[i].charCodeAt() >= 65 && word[i].charCodeAt() <= 90 || word[i].charCodeAt() >= 97 && word[i].charCodeAt() <= 122) {
//             result = true;
//             break;
//         }  
//         else {
...
//     document.write(para.charAt(i+3) == 'The') ;
